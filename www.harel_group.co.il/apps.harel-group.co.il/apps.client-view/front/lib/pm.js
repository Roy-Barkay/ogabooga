...
function PostMsg_PortalAction(actionName){
	var myMessage = PostMsg_CreateXmlTextMessage("PortalAction", "actionName", actionName, PostMsg_PortalAction.arguments);
	PostMsg_Post(myMessage);  // do the post
}
...
$(document).ready(function(){
	...
	// a resize event using "jquery.ba-resize.min.js":
	
	//  In Minimi Never use resize
	$("body").resize(function(){ PostMsg_Resize(); }); 
	PostMsg_Resize();
