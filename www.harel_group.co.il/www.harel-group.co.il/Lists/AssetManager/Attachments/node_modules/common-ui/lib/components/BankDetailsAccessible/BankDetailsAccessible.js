...
var BankDetailsInner = function BankDetailsInner(_ref) {
  var _childProps$bank, _childProps$bank2, _childProps$bank3, _childProps$bank4, _childProps$branch, _childProps$branch2, _childProps$branch3, _childProps$branch4, _childProps$branch5, _childProps$accountNu, _childProps$accountNu2;
  ...
  var onBankChange = function onBankChange(event, value) {
    ...
    updateBranchList(event === null || event === void 0 ? void 0 : event.value, data);
  };
  return /*#__PURE__*/_react.default.createElement(_Grid.default, {
    ...
    item: true,
    xs: 12
  }, grid.bank), /*#__PURE__*/_react.default.createElement(_hds.AutoCompleteUi, (0, _extends2.default)({
    commonUIVersion: 3
  }, getFieldProps('bank'), {
    label: "\u05E9\u05DD \u05D1\u05E0\u05E7",
    id: "".concat(id, "-bankName"),
    bo: "".concat(dataHrlBo, "-bank"),
    disabled: loaderVisible,
    items: banks,
    onChange: onBankChange,
    value: bank === null || bank === void 0 ? void 0 : bank.label,
    inputBackgroundColor: 'white',
    hideAsterisk: false,
    searchBy: 'CONTAIN',
    isObjectOutput: true,
    commonV3: true,
    hint: childProps === null || childProps === void 0 ? void 0 : (_childProps$bank = childProps.bank) === null || _childProps$bank === void 0 ? void 0 : _childProps$bank.helperText
  }, childProps === null || childProps === void 0 ? void 0 : childProps.bank, {
    labelProps: _objectSpread({
      'data-hrl-bo': "".concat(dataHrlBo, "-bankLabel")
    }, childProps === null || childProps === void 0 ? void 0 : (_childProps$bank2 = childProps.bank) === null || _childProps$bank2 === void 0 ? void 0 : _childProps$bank2.labelProps),
    inputProps: _objectSpread({
      'data-hrl-bo': "".concat(dataHrlBo, "-bankInput"),
      'role': role,
      'aria-invalid': childProps === null || childProps === void 0 ? void 0 : (_childProps$bank3 = childProps.bank) === null || _childProps$bank3 === void 0 ? void 0 : _childProps$bank3.error
    }, childProps === null || childProps === void 0 ? void 0 : (_childProps$bank4 = childProps.bank) === null || _childProps$bank4 === void 0 ? void 0 : _childProps$bank4.inputProps)
  })), loaderVisible && /*#__PURE__*/_react.default.createElement("div", {
    style: {
      position: 'absolute',
      left: '40px',
      top: '32px'
    ...
    item: true,
    xs: 12
  }, grid.branch), /*#__PURE__*/_react.default.createElement(_hds.AutoCompleteUi, (0, _extends2.default)({
    commonV3: true
  }, getFieldProps('branch'), {
    label: "\u05DE\u05E1\u05E4\u05E8 \u05D0\u05D5 \u05E9\u05DD \u05D4\u05E1\u05E0\u05D9\u05E3",
    id: "".concat(id, "-branchName"),
    bo: "".concat(dataHrlBo, "-branch"),
    disabled: !branches.length || (childProps === null || childProps === void 0 ? void 0 : (_childProps$branch = childProps.branch) === null || _childProps$branch === void 0 ? void 0 : _childProps$branch.required) && !(bank !== null && bank !== void 0 && bank.label),
    items: branches,
    onChange: function onChange(event, value) {
      return setFieldValue('branch', value);
    },
    value: (branch === null || branch === void 0 ? void 0 : branch.label) || '',
    inputBackgroundColor: 'white',
    hideAsterisk: false,
    searchBy: 'CONTAIN',
    isObjectOutput: true,
    hint: childProps === null || childProps === void 0 ? void 0 : (_childProps$branch2 = childProps.branch) === null || _childProps$branch2 === void 0 ? void 0 : _childProps$branch2.helperText
  }, childProps === null || childProps === void 0 ? void 0 : childProps.branch, {
    labelProps: _objectSpread({
      'data-hrl-bo': "".concat(dataHrlBo, "-branchLabel")
    }, childProps === null || childProps === void 0 ? void 0 : (_childProps$branch3 = childProps.branch) === null || _childProps$branch3 === void 0 ? void 0 : _childProps$branch3.labelProps),
    inputProps: _objectSpread({
      'data-hrl-bo': "".concat(dataHrlBo, "-branchInput"),
      'role': role,
      'aria-invalid': childProps === null || childProps === void 0 ? void 0 : (_childProps$branch4 = childProps.branch) === null || _childProps$branch4 === void 0 ? void 0 : _childProps$branch4.error
    }, childProps === null || childProps === void 0 ? void 0 : (_childProps$branch5 = childProps.branch) === null || _childProps$branch5 === void 0 ? void 0 : _childProps$branch5.inputProps)
  }))), !disableAccountNumber && /*#__PURE__*/_react.default.createElement(_Grid.default, (0, _extends2.default)({
    item: true,
    xs: 12
    ...
    mask: '99999999999999',
    disabled: !(bank !== null && bank !== void 0 && bank.label),
    required: childProps === null || childProps === void 0 ? void 0 : (_childProps$accountNu = childProps.accountNumber) === null || _childProps$accountNu === void 0 ? void 0 : _childProps$accountNu.required,
    helperText: childProps === null || childProps === void 0 ? void 0 : (_childProps$accountNu2 = childProps.accountNumber) === null || _childProps$accountNu2 === void 0 ? void 0 : _childProps$accountNu2.helperText
...
var BankDetailsAccessible = function BankDetailsAccessible(props) {
...
BankDetailsAccessible.propTypes = _objectSpread(_objectSpread({}, propTypes), _useReduxField.propTypes);
BankDetailsAccessible.defaultProps = _objectSpread({}, defaultProps);
BankDetailsAccessible.displayName = 'BankDetailsAccessible';
var _default = BankDetailsAccessible;
