...
require("./../colorAccessibility.css");
...
function Select(props) {
  ...
  var pickedProps = (0, _utils.pick)(['value', 'error', 'helperText', 'defaultValue', 'onChange', 'onBlur', 'multiple', 'required', 'label', 'id', 'name', 'disabled', 'children', 'data-hrl-bo', 'classes', 'MenuProps', 'orderLabel', 'renderValue', 'multilinelabel', 'maxheight', 'virtuallist', 'aria-describedby'], props);
  ...
  var ariaDescribedby = function ariaDescribedby() {
    var y = pickedProps['aria-describedby'] ? pickedProps['aria-describedby'] : '';
    if (fieldHelperText) {
      y = "".concat(y, " ").concat(hrlBo, "-helper-text");
    }
    return y.trimStart();
  };
  var detectIOSMobile = function detectIOSMobile() {
    return /iPhone|iPad|iPod|Android/i.test(navigator.userAgent || navigator.vendor);
  };
  var SelectDisplayProps = Object.assign({}, {
    'aria-expanded': open,
    'aria-invalid': !!fieldError,
    //'aria-labelledby': `label-${pickedProps.id} ${pickedProps.id}`,
    'aria-required': pickedProps.required
  },
  //fieldHelperText && {'aria-describedby': `${hrlBo}-helper-text`},
  pickedProps.value && {
    ...
    'aria-labelledby': detectIOSMobile() ? "label-".concat(pickedProps.id, " ").concat(pickedProps.id) : "label-".concat(pickedProps.id)
  });
  ...
  }, [pickedProps === null || pickedProps === void 0 ? void 0 : (_pickedProps$children5 = pickedProps.children) === null || _pickedProps$children5 === void 0 ? void 0 : _pickedProps$children5.length]);

  // fix role attribute to 'combobox' for accessibility mode
  _react.default.useEffect(function () {
    if (componentRef.current) {
      var allSelectComponents = componentRef.current.querySelectorAll('[data-isSelectComponent] > div[role="button"]');
  ...
  return /*#__PURE__*/_react.default.createElement(_FormControl.default, {
    ...
    inputProps: _objectSpread(_objectSpread({}, pickedProps.inputProps), props.inputProps || {}),
