...
var getInitialValue = function getInitialValue(props) {
  ...
  var value = (props === null || props === void 0 ? void 0 : props.value) || (props !== null && props !== void 0 && props.form ? props === null || props === void 0 ? void 0 : (_props$field = props.field) === null || _props$field === void 0 ? void 0 : _props$field.value : null);
  return value ? (0, _moment.default)(value, (props === null || props === void 0 ? void 0 : props.format) || defaultDateFormat) : null;
};
var DatePickerCommon = function DatePickerCommon(props) {
  ...
  var handleChange = function handleChange(momentObj, date) {
    ...
    if (props.form) {
      e.target = {
        ...
        value: momentObj || date
      };
      props.field.onChange(e);
    }
    /* eslint-enable react/prop-types */
    props === null || props === void 0 ? void 0 : (_props$onChange = props.onChange) === null || _props$onChange === void 0 ? void 0 : _props$onChange.call(props, momentObj, date);
    value.current = momentObj || date;
  };
  ...
  var ariaDescribedby = function ariaDescribedby() {
    return hasError || props.helperText ? "".concat(props.id, "-helper-text") : '';
  };
  var extraProps = {
    inputProps: {
      ...
      'aria-labelledby': props !== null && props !== void 0 && props.ariaLabelledby ? "".concat(props.id, "-label ").concat(props.ariaLabelledby) : "".concat(props.id, "-label"),
      'aria-describedby': ariaDescribedby(),
      //'aria-describedby': props?.ariaDescribedby ? `${props.ariaDescribedby} ${ariaDescribedby()}` : ariaDescribedby(),
      style: {
        direction: 'ltr',
        textAlign: 'right'
      },
