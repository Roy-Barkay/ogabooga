...
var CreditCardInner = function CreditCardInner(_ref) {
  ...
  var useStyles = (0, _styles.makeStyles)(function (theme) {
    return {
      '@global': {
        '.MuiInput-input.redLine:required:invalid': {
          borderBottom: '2px solid #d32704 !important'
        },
        '.inputWrapper': {
          '& .MuiInputBase-root:has(input.redLine:required:invalid)': {
            '&:before, &:hover:before': {
              border: '0 !important'
            }
          },
          '& .MuiFormControl-root:has(input.redLine:required:invalid) label.MuiInputLabel-root': {
            color: '#C72200'
          }
        },
        '& div[class*="ImagineAutocompleteUi"] > div[class*="error"] label span[class*="labelText"]': {
          color: '#C72200 !important'
        },
        '& div[class*="ImagineAutocompleteUi"] label span[class*="asterisk"]': {
          color: '#D32704'
        },
        '& div[class*="ImagineAutocompleteUi"] span[id*="errMsg"]': {
          color: '#C72200 !important'
        },
        '& div[class*="ImagineAutocompleteUi"] > div[class*="error"] input[id*="AutoCompleteInput"]': {
  ...
  useStyles();
  var setBorder = function setBorder(event) {
    var _event$target;
    if (event !== null && event !== void 0 && (_event$target = event.target) !== null && _event$target !== void 0 && _event$target.required && !event.target.classList.contains('redLine')) {
      event.target.classList.add('redLine');
    }
  };
  var onFocusHandler = function onFocusHandler(event) {
    event.target.classList.remove('redLine');
  };
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_Grid.default, {
    ...
    item: true
  }, grid.month), /*#__PURE__*/_react.default.createElement(_hds.AutoCompleteUi, (0, _extends2.default)({
    commonUIVersion: 3
  }, getFieldProps(FIELDS.MONTH), {
    label: "\u05D7\u05D5\u05D3\u05E9",
    id: "".concat(id, "-month"),
    bo: "".concat(dataHrlBo, "-month"),
    items: monthOptions.map(function (option) {
      return {
    ...
    onChange: function onChange(e) {
      var _e$target;
      handleChange(FIELDS.MONTH)((0, _misc.getEventData)(fieldName, e === null || e === void 0 ? void 0 : (_e$target = e.target) === null || _e$target === void 0 ? void 0 : _e$target.value));
    },
    value: month,
    ...
    item: true
  }, grid.year), /*#__PURE__*/_react.default.createElement(_hds.AutoCompleteUi, (0, _extends2.default)({
    commonUIVersion: 3
  }, getFieldProps(FIELDS.YEAR), {
    label: "\u05E9\u05E0\u05D4",
    id: "".concat(id, "-year"),
    bo: "".concat(dataHrlBo, "-year"),
    items: yearOptions.map(function (option) {
      return {
        label: option.toString(),
        value: option.toString()
      };
    ...
    onChange: function onChange(e) {
      var _e$target2;
      handleChange(FIELDS.YEAR)((0, _misc.getEventData)(fieldName, e === null || e === void 0 ? void 0 : (_e$target2 = e.target) === null || _e$target2 === void 0 ? void 0 : _e$target2.value));
    },
    value: year
...
var CreditCardAccessible = function CreditCardAccessible(props) {
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, (0, _useReduxField.default)(CreditCardInner)(props));
};
CreditCardAccessible.propTypes = _objectSpread(_objectSpread({}, propTypes), _useReduxField.propTypes);
CreditCardAccessible.defaultProps = _objectSpread({}, defaultProps);
CreditCardAccessible.displayName = 'CreditCardAccessible';
var _default = CreditCardAccessible;
