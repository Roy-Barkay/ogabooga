...
var Address = function Address(props) {
  var _props$autoSelect, _props$childProps2, _props$autoSelect2, _props$childProps3, _props$autoSelect3, _props$childProps4, _props$childProps5, _props$childProps6, _props$childProps7;
  ...
  var addressID = (0, _react.useRef)();
  addressID.current = props.id ? props.id : "address_id_".concat(Math.random().toString(36).slice(-4));
  ...
  var pathUrls = {
    ...
    streets: function streets(cityCode) {
      return "".concat(url, "/streets-with-code/?cityCode=").concat(cityCode);
    },
  ...
  var fetchData = function fetchData(type, url, formatter, setterFunc) {
    ...
    _axios.default.get(url).then(function (res) {
      ...
      onDataReceived === null || onDataReceived === void 0 ? void 0 : onDataReceived({
        type: type,
        data: null,
        error: true,
        errorMessage: e,
  ...
  var streetChangeHandler = function streetChangeHandler(event, value, reason) {
    switch (reason) {
      case 'clear':
        handleChange('street')((0, _misc.getEventData)(fieldName, ''));
        handleChange('houseNumber')((0, _misc.getEventData)(fieldName, ''));
        //handleChange('postalCode')(getEventData(fieldName, ''));
        handleChange('apartmentNumber')((0, _misc.getEventData)(fieldName, ''));
        handleChange('MailBox')((0, _misc.getEventData)(fieldName, ''));
        break;
      case 'select-option':
  ...
  return /*#__PURE__*/_react.default.createElement(_index.Grid, {
    ...
    autoHighlight: true,
    autoSelect: (_props$autoSelect = props.autoSelect) !== null && _props$autoSelect !== void 0 ? _props$autoSelect : true,
    inputProps: props.inputProps,
    role: props.role,
    InputProps: props.InputProps,
    isMatchFromStart: props.isFilterByStartWith,
    disablePortal: true,
    id: "".concat(addressID.current, "_city")
    ...
    autoHighlight: true,
    autoSelect: (_props$autoSelect2 = props.autoSelect) !== null && _props$autoSelect2 !== void 0 ? _props$autoSelect2 : true,
    inputProps: props.inputProps,
    role: props.role,
    InputProps: props.InputProps,
    isMatchFromStart: props.isFilterByStartWith,
    disablePortal: true,
    id: "".concat(addressID.current, "_street")
    ...
    autoHighlight: true,
    autoSelect: (_props$autoSelect3 = props.autoSelect) !== null && _props$autoSelect3 !== void 0 ? _props$autoSelect3 : true,
    inputProps: props.inputProps,
    role: props.role,
    InputProps: props.InputProps,
    disablePortal: true,
    id: "".concat(addressID.current, "_houseNumber")
  ...
  }, (_props$childProps5 = props.childProps) === null || _props$childProps5 === void 0 ? void 0 : _props$childProps5.apartmentNumber, {
    id: "".concat(addressID.current, "_apartmentNumber")
  }))), !hideMailBoxField && /*#__PURE__*/_react.default.createElement(_index.Grid, (0, _extends2.default)({
    item: true,
    xs: 12
  ...
  }, (_props$childProps6 = props.childProps) === null || _props$childProps6 === void 0 ? void 0 : _props$childProps6.MailBox, {
    id: "".concat(addressID.current, "_mailbox")
  }))), /*#__PURE__*/_react.default.createElement(_index.Grid, (0, _extends2.default)({
    item: true,
    xs: 12
    ...
    id: "".concat(addressID.current, "_postalCode")
  }))));
};
...
var propTypes = {
  ...
  /** Attribute of AutoComplete component*/
