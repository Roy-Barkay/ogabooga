...
var CurrencyMask = function CurrencyMask(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_reactTextMask.default, (0, _extends2.default)({}, props, {
    mask: numberMask,
  ...
  return /*#__PURE__*/_react.default.createElement(_TextField.default, (0, _extends2.default)({
    ...
    InputProps: {
      inputComponent: function inputComponent(inputProps) {
        return CurrencyMask(_objectSpread(_objectSpread({}, props), inputProps));
      }
    }
  }));
};
