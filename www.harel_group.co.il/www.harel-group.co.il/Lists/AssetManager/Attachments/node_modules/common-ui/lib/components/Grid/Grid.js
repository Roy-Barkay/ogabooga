...
function Grid(props) {
  ...
  var pickedProps = (0, _utils.pick)(['alignContent', 'alignItems', 'children', 'classes', 'container', 'direction', 'item', 'justify', 'lg', 'md', 'sm', 'spacing', 'wrap', 'xl', 'xs', 'style', 'data-hrl-bo', 'role', 'aria-label', 'aria-required', 'aria-describedby', 'aria-labelledby', 'id', 'className'], props);

  // set grid as container if not defined as container and item
