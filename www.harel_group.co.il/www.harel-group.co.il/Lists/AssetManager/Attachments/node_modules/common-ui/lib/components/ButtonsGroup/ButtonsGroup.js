...
function ButtonsGroup(props) {
  ...
  var groupProps = (0, _utils.pick)(['items', 'label', 'labelId', 'value', 'onChange', 'aria-label', 'aria-required', 'aria-describedby'], props);
  ...
  var buttonGroupsWrapperProps = Object.assign({}, {
    role: 'radiogroup',
    'aria-required': groupProps['aria-required'],
...
ButtonsGroup.propTypes = {
  ...
  /**The aria-required of the group. */
