...
function Toggle(props) {
  ...
  var children = props.children,
    ...
    _props$bgContentColor = props.bgContentColor,
    bgContentColor = _props$bgContentColor === void 0 ? 'white' : _props$bgContentColor,
    hideRequiredAsterisk = props.hideRequiredAsterisk;
  var makeStylesForbgContentColor = (0, _styles.makeStyles)(function () {
    return {
      contents: {
        backgroundColor: bgContentColor || 'white'
      }
    };
  });
  var backgroundColorClass = makeStylesForbgContentColor();
  var _useState = (0, _react.useState)(value || null),
    _useState2 = (0, _slicedToArray2.default)(_useState, 2),
    checkedOption = _useState2[0],
    setCheckedOption = _useState2[1];
  // const dataHrlBo = props['data-hrl-bo'];
  ...
  return /*#__PURE__*/_react.default.createElement(_core.FormControl, {
    error: fieldError,
    className: "".concat(backgroundColorClass.contents),
...
Toggle.propTypes = {
   ...
   */
  bgContentColor: _propTypes.default.string
};
Toggle.defaultProps = {
  onChange: noop,
  asSwitch: false,
