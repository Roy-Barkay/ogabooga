...
export interface FileUploadProps {
  ...
  onFinishUploading?: (fileItem: FileUploadItem, fileTypeCode: string | number) => void;
...
export const FileUpload = forwardRef<FileUploadRef, FileUploadProps>((props, ref): JSX.Element => {
  const {
  ...
  const onFinishUploadingFile = (file: FileUploadItem, fileTypeCode: string | number) => {
    onFinishUploading?.(file, fileTypeCode);
  }
      ...
      {fileTypes?.map((fileType) => {
        return (
          <TypeItem
            ...
            ariaDescribedby={fileType.ariaDescribedby}
          />
        );
      })}
    </div>
