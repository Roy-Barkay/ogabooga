...
export const SearchItems = ({itemOptions = [], searchBy, search, updateValueByClick}: any) => {
  ...
  const boldSearchLettersOfFilter = (value: SearchItem): JSX.Element => {
  ...
  return itemOptions.map((item: SearchItem, index: number) =>
    <li tabIndex={0}
        role='option'
