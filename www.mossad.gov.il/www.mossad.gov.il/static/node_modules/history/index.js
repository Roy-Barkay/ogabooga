...
function createHashHistory(options) {
  ...
  var _options2 = options,
    ...
    window =
      _options2$window === void 0 ? document.defaultView : _options2$window;
  var globalHistory = window.history;
  function getIndexAndLocation() {
  ...
  function push(to, state) {
    ...
    process.env.NODE_ENV !== "production"
      ...
      : void 0;
    if (allowTx(nextAction, nextLocation, retry)) {
      var _getHistoryStateAndUr3 = getHistoryStateAndUrl(
          nextLocation,
          index + 1
        ),
  ...
  function replace(to, state) {
    ...
    process.env.NODE_ENV !== "production"
      ? warning(
          nextLocation.pathname.charAt(0) === "/",
          "Relative pathnames are not supported in hash history.replace(" +
            JSON.stringify(to) +
            ")"
        )
      : void 0;
...
function createMemoryHistory(options) {
  ...
  var _options3 = options,
    ...
    initialEntries =
      _options3$initialEntr === void 0 ? ["/"] : _options3$initialEntr,
    initialIndex = _options3.initialIndex;
  var entries = initialEntries.map(function (entry) {
    var location = readOnly(
      _extends(
        {
          pathname: "/",
          search: "",
