...
function rankRouteBranches(branches) {
  branches.sort(function (a, b) {
    return a.score !== b.score
      ...
      : compareIndexes(
          a.routesMeta.map(function (meta) {
...
function compareIndexes(a, b) {
  var siblings =
    a.length === b.length &&
    a.slice(0, -1).every(function (n, i) {
      return n === b[i];
    });
  return siblings
...
function useNavigate() {
  ...
  var routePathnamesJson = JSON.stringify(
...
function Router(_ref3) {
  var _ref3$basename = _ref3.basename,
    ...
    navigationType =
      _ref3$navigationType === void 0 ? Action.Pop : _ref3$navigationType,
