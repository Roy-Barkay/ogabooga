import _slicedToArray from "C:\\Users\\RaamM\\rohm\\node_modules\\babel-preset-react-app\\node_modules\\@babel\\runtime/helpers/esm/slicedToArray";
import _toConsumableArray from "C:\\Users\\RaamM\\rohm\\node_modules\\babel-preset-react-app\\node_modules\\@babel\\runtime/helpers/esm/toConsumableArray";
import _classCallCheck from "C:\\Users\\RaamM\\rohm\\node_modules\\babel-preset-react-app\\node_modules\\@babel\\runtime/helpers/esm/classCallCheck";
import _createClass from "C:\\Users\\RaamM\\rohm\\node_modules\\babel-preset-react-app\\node_modules\\@babel\\runtime/helpers/esm/createClass";
...
var textEncoder = globalObject.TextEncoder
  ? new globalObject.TextEncoder()
  : null;
function intArrayToString(arr, len) {
  return String.fromCharCode.apply(
    String,
    _toConsumableArray(arr.subarray(0, len))
  );
}
          ...
          switch ((_context4.prev = _context4.next)) {
            ...
            case 5:
              ...
              save = function save() {
                ...
                var memoryBuffer = wasmInstance.exports.memory.buffer;
                var internalState = new Uint8Array(
                  memoryBuffer,
                  stateOffset,
                  stateLength
                );
                ...
                var prefixedState = new Uint8Array(
                ...
                if (state.length !== overallLength) {
                  throw new Error(
                    "Bad state length (expected "
                      .concat(overallLength, " bytes, got ")
                      .concat(state.length, ")")
                  );
                }
                if (
              ...
              _context4.t0 = binary.name;
              _context4.next =
                _context4.t0 === "argon2"
                  ? 24
                  : _context4.t0 === "scrypt"
                  ? 24
                  : _context4.t0 === "blake2b"
                  ? 26
                  : _context4.t0 === "blake2s"
                  ? 26
                  : _context4.t0 === "blake3"
                  ? 28
                  : _context4.t0 === "xxhash64"
                  ? 30
                  : _context4.t0 === "xxhash3"
                  ? 30
                  : _context4.t0 === "xxhash128"
                  ? 30
                  : 32;
              break;
            case 24:
...
function adler32(data) {
  if (wasmCache$l === null) {
    return lockedCreate(mutex$l, wasmJson$k, 4).then(function (wasm) {
      wasmCache$l = wasm;
...
function createAdler32() {
  return WASMInterface(wasmJson$k, 4).then(function (wasm) {
    wasm.init();
    var obj = {
      init: function init() {
        wasm.init();
...
function blake2b(data) {
  var bits =
    arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 512;
  var key =
...
function encodeResult(salt, options, res) {
  var parameters = [
    "m=".concat(options.memorySize),
    "t=".concat(options.iterations),
    "p=".concat(options.parallelism),
  ].join(",");
  return "$argon2"
    .concat(options.hashType, "$v=19$")
    .concat(parameters, "$")
    .concat(encodeBase64(salt, false), "$")
    .concat(encodeBase64(res, false));
}
          ...
          switch ((_context7.prev = _context7.next)) {
            ...
            case 57:
              ...
              return _context7.abrupt(
                "return",
                getDigestHex(_digestChars, res, hashLength)
              );
            case 61:
...
var validateOptions$3 = function validateOptions$3(options) {
  ...
  if (!["hex", "binary", "encoded"].includes(options.outputType)) {
    throw new Error(
      "Insupported output type ".concat(
        options.outputType,
        ". Valid values: ['hex', 'binary', 'encoded']"
      )
    );
  }
};
...
var getHashParameters = function getHashParameters(password, encoded) {
  var regex =
  ...
  parameters.split(",").forEach(function (x) {
        ...
        while (1)
          switch ((_context11.prev = _context11.next)) {
            case 0:
              ...
              params = getHashParameters(options.password, options.hash);
            ...
            case 6:
              ...
              return _context11.abrupt(
                "return",
                result.substring(hashStart) ===
                  options.hash.substring(hashStart)
              );
            case 8:
            case "end":
...
function blake2s(data) {
  ...
  if (wasmCache$j === null || wasmCache$j.hashLength !== hashLength) {
    return lockedCreate(mutex$j, wasmJson$h, hashLength).then(function (wasm) {
      wasmCache$j = wasm;
      if (initParam > 512) {
...
function blake3(data) {
  ...
  if (wasmCache$i === null || wasmCache$i.hashLength !== hashLength) {
    return lockedCreate(mutex$i, wasmJson$g, hashLength).then(function (wasm) {
      wasmCache$i = wasm;
      if (initParam === 32) {
...
function createBLAKE3() {
  ...
  return WASMInterface(wasmJson$g, outputSize).then(function (wasm) {
    if (initParam === 32) {
      wasm.writeMemory(keyBuffer);
    }
    wasm.init(initParam);
...
function crc32(data) {
  if (wasmCache$h === null) {
    return lockedCreate(mutex$h, wasmJson$f, 4).then(function (wasm) {
      wasmCache$h = wasm;
      return wasmCache$h.calculate(data, 0xedb88320);
    });
  }
  try {
    var _hash5 = wasmCache$h.calculate(data, 0xedb88320);
...
function createCRC32() {
  return WASMInterface(wasmJson$f, 4).then(function (wasm) {
...
function crc32c(data) {
  if (wasmCache$g === null) {
    return lockedCreate(mutex$g, wasmJson$f, 4).then(function (wasm) {
      wasmCache$g = wasm;
      return wasmCache$g.calculate(data, 0x82f63b78);
    });
  }
  try {
    var _hash6 = wasmCache$g.calculate(data, 0x82f63b78);
...
function sha3(data) {
  ...
  try {
    var _hash10 = wasmCache$c.calculate(data, bits, 0x06);
...
function keccak(data) {
  ...
  try {
    var _hash11 = wasmCache$b.calculate(data, bits, 0x01);
...
function sha224(data) {
  ...
  try {
    var _hash12 = wasmCache$a.calculate(data, 224);
...
function sha256(data) {
  ...
  try {
    var _hash13 = wasmCache$9.calculate(data, 256);
...
function sha384(data) {
  ...
  try {
    var _hash14 = wasmCache$8.calculate(data, 384);
...
function sha512(data) {
  ...
  try {
    var _hash15 = wasmCache$7.calculate(data, 512);
...
function xxhash32(data) {
  ...
  try {
    var _hash16 = wasmCache$6.calculate(data, seed);
...
function xxhash64(data) {
  ...
  try {
    writeSeed$2(seedBuffer$2, seedLow, seedHigh);
    wasmCache$5.writeMemory(new Uint8Array(seedBuffer$2));
    var _hash17 = wasmCache$5.calculate(data);
...
function createXXHash64() {
  ...
  return WASMInterface(wasmJson$7, 8).then(function (wasm) {
    var instanceBuffer = new ArrayBuffer(8);
...
function xxhash3(data) {
  ...
  try {
    writeSeed$1(seedBuffer$1, seedLow, seedHigh);
    wasmCache$4.writeMemory(new Uint8Array(seedBuffer$1));
    var _hash18 = wasmCache$4.calculate(data);
...
function xxhash128(data) {
  ...
  try {
    writeSeed(seedBuffer, seedLow, seedHigh);
    wasmCache$3.writeMemory(new Uint8Array(seedBuffer));
    var _hash19 = wasmCache$3.calculate(data);
...
function ripemd160(data) {
  ...
  try {
    var _hash20 = wasmCache$2.calculate(data);
        ...
        while (1)
          switch ((_context12.prev = _context12.next)) {
            case 0:
              ...
              return _context12.abrupt("return", DK);
            case 14:
              digestChars = new Uint8Array(hashLength * 2);
              return _context12.abrupt(
                "return",
                getDigestHex(digestChars, DK, hashLength)
              );
            case 16:
            case "end":
      ...
      return _regeneratorRuntime().wrap(function _callee14$(_context14) {
        while (1)
          switch ((_context14.prev = _context14.next)) {
            ...
            case 4:
              blockData = _context14.sent;
              _context14.next = 7;
              return WASMInterface(wasmJson$3, 0);
            case 7:
              scryptInterface = _context14.sent;
            ...
            case 16:
              ...
              return _context14.abrupt(
                "return",
                getDigestHex(_digestChars2, outputData, hashLength)
              );
            case 20:
              return _context14.abrupt("return", outputData);
            case 21:
            case "end":
        ...
        while (1)
          switch ((_context15.prev = _context15.next)) {
            case 0:
              ...
              return _context15.abrupt("return", scryptInternal(options));
            case 2:
            case "end":
        ...
        while (1)
          switch ((_context16.prev = _context16.next)) {
            ...
            case 3:
              ...
              return _context16.abrupt("return", intArrayToString(memory, 60));
            case 12:
              if (!(options.outputType === "hex")) {
                _context16.next = 15;
                break;
              ...
              return _context16.abrupt(
                "return",
                getDigestHex(_digestChars3, memory, 24)
              );
            case 15:
              return _context16.abrupt("return", memory.slice(0, 24));
            case 16:
            case "end":
        ...
        while (1)
          switch ((_context17.prev = _context17.next)) {
            case 0:
              ...
              return _context17.abrupt("return", bcryptInternal(options));
            case 2:
            case "end":
        ...
        while (1)
          switch ((_context18.prev = _context18.next)) {
            case 0:
              ...
              return WASMInterface(wasmJson$2, 0);
            case 4:
              bcryptInterface = _context18.sent;
...
function whirlpool(data) {
  ...
  try {
    var _hash21 = wasmCache$1.calculate(data);
    return Promise.resolve(_hash21);
  } catch (err) {
    return Promise.reject(err);
  }
}
...
function sm3(data) {
  ...
  try {
    var _hash22 = wasmCache.calculate(data);
    return Promise.resolve(_hash22);
  } catch (err) {
    return Promise.reject(err);
  }
}
