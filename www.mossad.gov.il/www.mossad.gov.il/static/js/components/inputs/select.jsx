...
const Select = ({name, placeholder, value, onChange, options, label, error, defaultOption ,required}) => {
    return <React.Fragment>
            ...
            <select type="text" name={name} id={name}  defaultValue="" value={defaultOption? defaultOption : value} onChange={onChange} className={error && "error-input"} required={required}>
