...
const ContactUsFA = ({ translation, changeLanguage }) => {
  ...
  useEffect(() => {
    ...
    changeLanguage({ lang: "en", dir: "ltr" });
  ...
  useEffect(() => {
    TagManager.initialize({ gtmId: "G-FMNHNGNYC9" });
  }, [success]);
  ...
  return (
    <div className="page-content contact-us" dir="rtl">
      <BreadCrumbs
              ...
              <div>
                ...
                <div>
                  <Select
                    ...
                    options={cuCatalogs.languages ? cuCatalogs.languages : []}
                    onChange={handleChange}
                    defaultOption={""}
          ...
          <React.Fragment>
            ...
            <p
              dangerouslySetInnerHTML={{
                __html: translation.data.FORM.SUCCESS_PARA,
              }}
            ></p>
          </React.Fragment>
        )}
